...
//Rotas de CRUD
app.post('/posts', postConstroller.cadastrarPost) //Create
//Post => semelhante a um 'print', em outras linguagens
//Posts => enviar dados ao blog (método da API)
app.get('/posts', postsController.listarPosts) //Read
//Get => Semelhante a um SELECT, em SQL
//Posts => Chama os dados da DataBase
